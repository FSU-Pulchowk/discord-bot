...
import { 
    handleAnnouncementModal as handleOldAnnouncementModal 
    ...
    try {
        ...
        // Handle modals
            ...
            try {
                ...
                else if (customId.startsWith('announcement_modal_')) {
                    // Old announcement system for backward compatibility
                    await handleOldAnnouncementModal(interaction);
                }
        ...
        // Handle buttons
            ...
            try {
                ...
                // Join club buttons
                else if (customId.startsWith('join_club_')) {
                    await handleJoinClubButton(interaction);
                }
                
                // Join request response buttons
